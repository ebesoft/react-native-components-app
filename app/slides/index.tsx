    ...
    <ThemedView>
...

      {
        ...
        ? (
          ...
          className='absolute bottom-10 right-5 w-[150px]'>Finalizar</ThemedButton>
        )
        : (
        <ThemedButton 
          onPress={() => scrollToSlide(currentSlideIndex + 1)}
          className='absolute bottom-10 right-5 w-[150px]'>Siguiente</ThemedButton>
        )
      }
